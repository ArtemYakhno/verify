...
export function validateIsPropertyValid(
  value: unknown,
  ...
  if (typeof relatedPropertyName !== 'string') return false;
  if (!isCompareFn(compareFn)) return false;
    ...
    registerDecorator({
      ...
      validator: {
        validate(value: unknown, args: ValidationArguments) {
          return validateIsPropertyValid(value, args);
        },
      },
    });
  };
