...
export const IMAGE_MESSAGES = {
  ...
  METADATA_MISMATCH: 'Metadata count must match uploaded files count',
  INVALID_FILE_TYPE: 'Only JPEG, PNG and WebP files are allowed',

  INVALID_METADATA:
    'Metadata must be a valid JSON array. Example [{"name":"Jhon Snow","comment":"Actor"},{"name":null,"comment":null}]',
